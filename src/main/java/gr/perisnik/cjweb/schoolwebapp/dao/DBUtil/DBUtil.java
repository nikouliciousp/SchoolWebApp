package gr.perisnik.cjweb.schoolwebapp.dao.DBUtil;
...
public class DBUtil {
    ...
    static {
        ...
        ds.setUrl("jdbc:mysql://localhost:3306/schoolwebappdbcj?serverTimeZone=UTC");
        
        // Set the username for the database connection.
        ds.setUsername("shoolwebappdbcj");
